...
import com.MT_MX.demo.semantic.AccountInstitution;
import java.util.Collections;
import java.util.List;
import java.util.stream.Collectors;

public class Field57DParser {

    public static AccountInstitution parse(FieldNode field){
        ...
        return new AccountInstitution(account, name, address);
    }
}