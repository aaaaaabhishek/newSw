...
import com.MT_MX.demo.semantic.SenderCorrespondent;

import java.util.Collections;
import java.util.List;
import java.util.stream.Collectors;

public class Field53DParser {

    public static SenderCorrespondent parse(FieldNode field){
        ...
        return new SenderCorrespondent (account, name, address);
    }
}