...
import com.MT_MX.demo.semantic.IntermediaryInstitution;

import java.util.Collections;
import java.util.List;
import java.util.stream.Collectors;

public class Field56DParser {

    public static IntermediaryInstitution parse(FieldNode field){
        ...
        return new IntermediaryInstitution(account, name, address);
    }
}